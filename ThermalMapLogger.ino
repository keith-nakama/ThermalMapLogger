 ...
 *  Thermal Mapper v13.4 / Build 144
 * ============================================================
 *
 *  【概要】
...
const char *APP_BUILD   = "Build 144";
...
<title>Thermal Mapper v13.4 - Build 144</title>
<style>
...
<body onload="initApp()">
  <h3>Thermal Mapper [Grid: 11-88] 144</h3>
  <div class="app-meta"><span>v13.4 / Build 144</span><button id="aboutBtn" onclick="showAbout()">About</button></div>
  <div id="grid"></div>

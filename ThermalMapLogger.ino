 ...
 *  Thermal Mapper v13.4 / Build 143
 * ============================================================
 *
 *  【概要】
...
const char *APP_BUILD   = "Build 143";
...
<title>Thermal Mapper v13.4 - Build 143</title>
<style>
...
<body onload="initApp()">
  <h3>Thermal Mapper [Grid: 11-88] 143</h3>
  <div class="app-meta"><span>v13.4 / Build 143</span><button id="aboutBtn" onclick="showAbout()">About</button></div>
  <div id="grid"></div>
